...
export default function CommunityScreen({ user, onNavigate }) {
  return (
    <div style={{ display: "flex", minHeight: "100vh" }}>
      <Sidebar active="community" onNavigate={onNavigate} onLogout={() => console.log("logout")} />
      ...
      <div style={{ flex: 1, minWidth: 0, background: colors.base.appBackground, padding: 32 }}>
        ...
        >
          ...
          >
            <Users size={32} color={colors.brand?.primaryOrange || "#F5A623"} />
          </div>

...
const EXAMPLES = [
  ...
  "Stock Market Basics",
  "English Speaking for Professionals",
...
const S = {
  ...
  tagGold: {
    display: "inline-block",
    background: `${colors.brand.primaryOrange}1A`,
    border: `1px solid ${colors.brand.primaryOrange}4D`,
  ...
  pillGold: {
    background: `${colors.brand.primaryOrange}1A`,
    borderColor: `${colors.brand.primaryOrange}4D`,
    color: colors.brand.primaryOrange,
  },
  lbl: {
    fontSize: 10.5,
  ...
  mbox: {
    background: `${colors.brand.primaryOrange}0D`,
    border: `1px solid ${colors.brand.primaryOrange}33`,
    borderRadius: 12,
    padding: 16,
    textAlign: "center",
  },
  ...
  navBtn: (on) => ({
    ...
    border: on
      ? `1px solid ${colors.brand.primaryOrange}38`
...
export default function CoursePlannerScreen() {
  ...
  const MSGS = [
    ...
    "Writing lesson hooks…",
    "Crafting ad creatives…",
    "Forecasting revenue…",
    "Building scaling plan…",
    "Finalising growth hacks…",
  ];
  ...
  const handleDownloadPdf = () => {
    if (!plan) return;
    try {
      generatePlanPdf(plan, planNiche);
    } catch (e) {
          ...
          <div>
              ...
              <div>
                <div
                  style={{
                    ...S.card,
                    background: `${colors.brand.primaryOrange}0D`,
                    border: `1px solid ${colors.brand.primaryOrange}38`,
                    marginBottom: 14,
                  }}
                >
                  ...
                  >
                    {plan.course_idea.tagline}
                  </div>
                </div>
                <div style={S.card}>
                  <div style={S.lbl}>Why This Will Sell</div>
                  <div style={{ ...S.val, marginTop: 6 }}>
                    {plan.course_idea.why_it_sells}
                  </div>
                </div>
              </div>
            )}
            ...
            {section === "course_structure" && plan.course_structure && (
              <div>
                ...
                >
                  <div style={S.mbox}>
                    <div style={S.mval}>
                      {plan.course_structure.total_modules}
                    </div>
                    <div style={S.mlbl}>Modules</div>
                  </div>
                  <div style={S.mbox}>
                    <div style={S.mval}>
                      {plan.course_structure.total_lessons}
                    </div>
                    <div style={S.mlbl}>Total Lessons</div>
                  </div>
                </div>
                    ...
                    >
                      <div
                        style={{
                          width: 26,
                          height: 26,
                          background: `${colors.brand.primaryOrange}1F`,
                          borderRadius: 6,
                          display: "flex",
                          alignItems: "center",
                          justifyContent: "center",
                  ...
                  {plan.content_creation.lessons.map((l) => (
                    ...
                    >
                      ...
                      <div
                        style={{
                          background: `${colors.brand.primaryOrange}0D`,
                          border: `1px solid ${colors.brand.primaryOrange}2E`,
                          borderRadius: 10,
                          padding: "13px 15px",
                          marginBottom: 13,
                        }}
                      >
                        <div style={{ ...S.lbl, marginBottom: 5 }}>
                          Opening Hook
                        </div>
                        <div
                          style={{
            ...
            {section === "offer_creation" && plan.offer_creation && (
              <div>
                ...
                >
                  <div style={{ ...S.lbl, marginBottom: 9 }}>
                    Course Headline
                  </div>
                  <div
                    style={{
                  ...
                  >
                    {plan.offer_creation.subheadline}
                  </div>
                </div>
                <div style={{ ...S.card, marginBottom: 14 }}>
                  <div style={S.lbl}>
                    Sales Description (Pain → Agitate → Solve)
                  </div>
                  <div style={{ ...S.val, marginTop: 6 }}>
                    {plan.offer_creation.description}
                  </div>
                </div>
                <div
                  style={{
                    ...
                    return (
                      <div
                        ...
                        style={{
                          ...S.card,
                          borderColor: gold
                            ? `${colors.brand.primaryOrange}47`
                            : colors.base.border,
                        }}
                      >
                        <div
                          style={{
                            ...(gold ? S.tagGold : S.tag),
                            marginBottom: 11,
                          }}
                        >
                          {gold ? "High Ticket" : "Low Ticket"}
                        </div>
                        <div
                          style={{
                            fontSize: 22,
                        ...
                        >
                          {plan.offer_creation.pricing_strategy?.[tier]?.price}
                        </div>
                        ...
                        >
                          {
                            plan.offer_creation.pricing_strategy?.[tier]
                              ?.what_included
                          }
                        </div>
            ...
            {section === "target_audience" && plan.target_audience && (
              <div>
                ...
                >
                  <div style={S.mbox}>
                    <div style={{ ...S.mval, fontSize: 16 }}>
                      {plan.target_audience.age_group}
                    </div>
                    <div style={S.mlbl}>Age Group</div>
                  </div>
                  <div style={S.mbox}>
                    <div style={{ ...S.mval, fontSize: 15 }}>
                      {plan.target_audience.gender_split}
                    </div>
                    <div style={S.mlbl}>Gender Split</div>
                  </div>
                </div>
                <div style={{ ...S.card, marginBottom: 13 }}>
                  ...
                  >
                    {plan.target_audience.top_cities?.map((c) => (
                      <span key={c} style={{ ...S.pill, ...S.pillGold }}>
                        {c}
                      </span>
                    ))}
                  </div>
              ...
              <div>
                ...
                {plan.ad_strategy.meta?.creatives?.map((c, i) => (
                  <div key={i} style={{ ...S.card, marginBottom: 12 }}>
                    ...
                    <div
                      style={{
                        borderLeft: `3px solid ${colors.brand.primaryOrange}73`,
                        paddingLeft: 13,
                      }}
                    >
                      ...
                      >
                        ...
                        <span
                          style={{ ...S.pill, ...S.pillGold, fontSize: 11 }}
                        >
                          {c.cta}
                        </span>
                      </div>
                ...
                >
                  {[
                    [
                      "TOF",
                      plan.ad_strategy.meta?.funnel?.tof,
                      colors.brand.primaryOrange,
                    ],
                    [
                      "MOF",
                      plan.ad_strategy.meta?.funnel?.mof,
                      colors.brand.successGreen,
                    ],
                    ["BOF", plan.ad_strategy.meta?.funnel?.bof, "#DC2626"],
                  ].map(([s, t, col]) => (
                    <div
                      key={s}
                      style={{ ...S.card, borderLeft: `3px solid ${col}` }}
                    >
                      <div
                        style={{
                          fontSize: 11,
                ...
                {plan.ad_strategy.google?.keyword_clusters?.map((kc, i) => (
                  <div key={i} style={{ ...S.card, marginBottom: 10 }}>
                    <div style={{ ...S.lbl, marginBottom: 7 }}>
                      {kc.cluster_name}
                    </div>
                    <div style={{ display: "flex", flexWrap: "wrap", gap: 5 }}>
                      {kc.keywords?.map((k) => (
                        <span key={k} style={{ ...S.pill, fontSize: 11.5 }}>
                          {k}
                        </span>
                      ))}
                    </div>
                ...
                <div style={{ ...S.card, marginTop: 11 }}>
                  ...
                  <div style={{ ...S.val, marginTop: 5 }}>
                    {plan.ad_strategy.google?.intent_strategy}
                  </div>
                </div>
              </div>
            )}
              ...
              <div>
                ...
                >
                  {[
                    [
                      "TAM",
                      plan.audience_sizing.tam,
                      "Total Addressable Market",
                    ],
                    [
                      "SAM",
                      plan.audience_sizing.sam,
                      "Serviceable Addressable Market",
                    ],
                    [
                      "SOM",
                      plan.audience_sizing.som,
                      "Serviceable Obtainable (Yr 1)",
                    ],
                  ].map(([k, v, sub]) => (
                ...
                >
                  ...
                  >
                    <div>
                      <div style={S.lbl}>Meta Estimated Reach</div>
                      <div
                        style={{
                          fontSize: 19,
                          fontWeight: 800,
                      ...
                      >
                        {plan.audience_sizing.meta_estimated_reach}
                      </div>
                    </div>
                    <div style={{ textAlign: "right" }}>
                      <div style={S.lbl}>Year 1 Reachable</div>
                      <div style={{ ...S.val, marginTop: 4 }}>
                        {plan.audience_sizing.estimated_reachable}
                      </div>
                    </div>
                  </div>
                </div>
            ...
            {section === "revenue_forecast" && plan.revenue_forecast && (
              <div>
                ...
                >
                  {[
                    ["Assumed CTR", plan.revenue_forecast.assumed_ctr],
                    ["Assumed CVR", plan.revenue_forecast.assumed_cvr],
                    ["Cost Per Lead", plan.revenue_forecast.cost_per_lead],
                    ["Cost Per Sale", plan.revenue_forecast.cost_per_sale],
                  ].map(([k, v]) => (
                    <div key={k} style={S.mbox}>
                      <div style={{ ...S.mval, fontSize: 18 }}>{v}</div>
                      <div style={S.mlbl}>{k}</div>
                    </div>
                  ))}
                </div>
            ...
            {section === "scaling_plan" && plan.scaling_plan && (
              <div>
                {[
                  [
                    "🎯 Scale Trigger",
                    plan.scaling_plan.scale_trigger,
                    colors.brand.primaryOrange,
                  ],
                  [
                    "💸 Budget Allocation",
                    plan.scaling_plan.budget_allocation,
                    colors.brand.successGreen,
                  ],
                  [
                    "🔄 Retargeting Logic",
                    plan.scaling_plan.retargeting_logic,
                    colors.charts.purple,
                  ],
                  [
                    "♾️ LTV Optimization",
                    plan.scaling_plan.ltv_optimization,
                    colors.charts.blue,
                  ],
                ].map(([title, content, col]) => (
                  <div
                    key={title}
                    style={{
                      ...S.card,
                ...
                {plan.growth_hacks.map((h, i) => (
                  ...
                  >
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      <div style={{ ...S.val, fontSize: 13, marginBottom: 8 }}>
                        {h.mechanism}
                      </div>
                      <div
                        style={{

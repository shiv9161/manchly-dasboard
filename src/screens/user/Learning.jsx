...
import { Eye, EyeOff, Copy, Radio, BookOpen, Video } from "lucide-react";
    ...
    Promise.allSettled([
      ...
      apiFetch("/webinars/enrolled/me?page=1&limit=50&upcoming=true").then(
        (r) => {
          const d = unwrap(r);
          setWebinars(
            d?.webinars || d?.enrollments || (Array.isArray(d) ? d : []),
          );
        },
      ),
  ...
  const tabBtn = (t, label, count) => (
    ...
    >
      ...
      <span
        style={{
          background:
            tab === t ? "rgba(255,255,255,0.25)" : colors.user.cardSoft,
          borderRadius: 99,
          padding: "1px 8px",
          fontSize: 11.5,
          color: tab === t ? "#FFFFFF" : colors.user.text,
        }}
      >
        {count}
      </span>
                  ...
                  <div style={{ padding: 16 }}>
                    ...
                    {(w.zoom_meeting_id || w.zoom_password) && (
                      ...
                      >
                        ...
                        >
                          <span>
                            ID: <b>{shown ? w.zoom_meeting_id : "••••••••"}</b>{" "}
                    ...
                    >
                      <span
                        style={{ fontSize: 13, color: colors.user.subHeading }}
                      >
                      ...
                      <GradientButton
                        size="sm"
                        disabled={past}
                        gradient={past ? undefined : colors.gradients.greenButtonDark}
                        onClick={() =>
                          w.zoom_join_url

...
export default function CoursePreviewScreen({ user, onNavigate }) {
  ...
  const handleStepClick = (index) => {
    ...
    if (index === 0) {
      onNavigate?.("course-create", { courseId });
    } else if (index === 1) {
    ...
    <div style={{ display: "flex", minHeight: "100vh" }}>
      ...
      >
        ...
        >
          ...
          <div>
            <CourseTrailerPlayer
              playbackUrl={firstVideo?.playback_url}
            ...
            >
              ...
              <div>
                ...
                <div style={{ fontSize: 12, color: "#92400E", marginTop: 2 }}>
                  Review your course details carefully. You can go back and edit
                  anytime.
                </div>
              </div>
            </div>
        ...
        {error && (
          <div style={{ color: "red", fontSize: 13, marginTop: 16 }}>
            {error}
          </div>
        )}
  ...
  return (
    <div
      style={{
        ...
        justifyContent: "space-between",
        padding: "8px 0",
        borderBottom: last ? "none" : `1px solid ${colors.base.border}`,
      }}
    >
      <span style={{ fontSize: 12.5, color: colors.typography.secondaryText }}>
        {label}
      </span>
      <span
        style={{
